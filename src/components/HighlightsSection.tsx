...
const highlights = [
  ...
  },
  {
    ...
    desc: 'Am Samstag und Sonntag treten bis zu 20 Speditionen mit bis zu sechs Teilnehmern gegeneinander an und kämpfen um den Titel „Stärkste Spedition". Gefordert sind Kraft, Geschicklichkeit und vor allem echter Teamgeist.',
    img: hlStrength,
  },
  {
    icon: Music,
